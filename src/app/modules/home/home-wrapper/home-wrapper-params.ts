...
export const dataPage: Ipage[] = [
    ...
    {
        id: 4,
        imgMain: 'assets/images/home-1.jpg',
        title: 'Домашняя',
        topDescription:
            'Занятия спортом в тренажерном зале требуют много времени, которое уходит не только на само выполнение упражнений, но и на подготовку, а также дорогу от дома до фитнес-центра. В результате многие мужчины и женщины быстро теряют мотивацию и бросают тренировки. Но если желание стать стройнее велико, есть возможность поменять обстановку. Тренировка дома – не менее эффективный способ коррекции фигуры. Главное – знать, как правильно организовать процесс, чтобы достичь лучших результатов. Занятия в домашних условиях имеют определенные особенности. В первую очередь они касаются ограничений по используемому инвентарю. Но это не беда.',
        imgSecond: 'assets/images/home-2.jpg',
        bottomDescription:
            'Тренироваться дома можно разными способами. Количество вариантов занятий и программ практически бесконечное. Даже если вы новичок в спорте и не уверены, что сумеете самостоятельно достичь результатов, не стоит волноваться. Изучаем информацию, которая есть в свободном доступе ниже на нашем сайте, и начинаем формировать собственный план занятий. Уже через неделю активных, стабильных тренировок будет заметен результат.',
    },
];
